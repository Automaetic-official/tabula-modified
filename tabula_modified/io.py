...
def _run(
    ...
    """Call tabula-java with the given lists of Java options and tabula-modified
    ...
    """
    # Ignore some options that are set by tabula-modified
...
def read_pdf(
    ...
    Args:
        input_path (str, path object or file-like object):
            ...
            It can be URL, which is downloaded by tabula-modified automatically.
        ...
        multiple_tables (bool):
            ...
            Note:
                If `multiple_tables` option is enabled, tabula-modified uses not
    ...
    Examples:
        ...
        Notes:
            As of tabula-modified 2.0.0, :func:`read_pdf()` sets `multiple_tables=True` by
...
def _build_java_options(
    ...
    # to prevent tabula-modified from stealing focus on every call on mac
