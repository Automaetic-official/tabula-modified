...
def load_template(path_or_buffer: FileLikeObj) -> List[TabulaOption]:
    """Build tabula-modified option from template file
...
def _convert_template_option(
    ...
    """Convert Tabula app template to tabula-modified option

    Args:
        template (dict): Tabula app template

    Returns:
        `obj`:dict: tabula-modified option
    """
